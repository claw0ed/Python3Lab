...
import math
from math import pi
from math import pi, sqrt # 직접 기술해서 쓰는것이 좋음 (추천!)
from math import * # 쓰기 편하지만 비추
import claw0ed # 사용자 모듈
#import claw0ed.hello
from claw0ed.hello import sayHello

# 모듈을 호출할때는 모듈명(파일이름).함수명
print( random.randint(1, 10) )
print( r.randint(1, 10) ) # import random as r # 별칭으로 줄여쓰기
print( randint(1, 10) ) # from random import randint # 모듈명을 아예 줄여쓰기
